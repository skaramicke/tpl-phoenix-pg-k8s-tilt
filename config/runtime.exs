...
#
#     PHX_SERVER=true bin/tpl_phoenix_pg_k8s_tilt start
#
...
if config_env() in [:prod, :dev_cluster] do
  ...
  config :tpl_phoenix_pg_k8s_tilt, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :tpl_phoenix_pg_k8s_tilt, TplPhoenixPgK8sTilt.Mailer,
